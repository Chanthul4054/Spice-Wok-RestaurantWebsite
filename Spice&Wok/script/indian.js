...
fetch('../xml/indian.xml')
    ...
    .then(data => {
        ...
        const container1 = document.getElementById('indianAppetizers-container');
        const container2 = document.getElementById('indianMain-container');
        const container3 = document.getElementById('indianDessert-container');
